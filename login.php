...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Feedall | Login page</title>
                ...
                <div class="row g-0 h-100">
                  <div class="col-md-5 text-center bg-card-gradient">
                    <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                      ...
                      <div class="z-index-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-4 d-inline-block fw-bolder" href="index.php">Feedall</a>
                        <p class="opacity-75 text-white">Avec la puissance de Feeedall, vous pouvez désormais vous concentrer uniquement sur les fonctionnalités de vos projets !</p>
                      </div>
                    </div>
                    <div class="mt-3 mb-4 mt-md-4 mb-md-5 light">
                      <p class="text-white">Vous n'avez pas de compte ?<br><a class="text-decoration-underline link-light" href="register.php">Inscrivez-vous !</a></p>
                      <p class="mb-0 mt-4 mt-md-5 fs--1 fw-semi-bold text-white opacity-75">Lisez nos <a class="text-decoration-underline text-white" href="#!">termes</a> et <a class="text-decoration-underline text-white" href="#!">conditions</a></p>
                    </div>
                  </div>
                        ...
                        <div class="row flex-between-center">
                          <div class="col-auto">
                            <div class="form-check mb-0">
                              ...
                              <label class="form-check-label mb-0" for="card-checkbox">Enregistrer</label>
                            </div>
                          </div>
                          <div class="col-auto"><a class="fs--1" href="User/reset.php">Mot de passe oublié ?</a></div>
                        </div>
                        <div class="mb-3">
                          <button class="btn btn-primary d-block w-100 mt-3" type="submit" name="submit">Se connecter</button>
                        </div>
                      </form>
                      <div class="position-relative mt-4">
                        <hr class="bg-300" />
                        <div class="divider-content-center">ou connectez-vous avec</div>
                      </div>

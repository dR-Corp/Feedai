  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-standard navbar-expand-lg fixed-top navbar-dark" data-navbar-darken-on-scroll="data-navbar-darken-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.php"><span class="text-white dark__text-white">Feedall</span></a>
          ...
          <div class="collapse navbar-collapse scrollbar" id="navbarStandard">
            <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
              ...
              <li class="nav-item"><a class="nav-link" href="dashboard.php" role="button" aria-haspopup="true" aria-expanded="false" id="what">What</a></li>
              <li class="nav-item"><a class="nav-link" href="dashboard.php" role="button" aria-haspopup="true" aria-expanded="false" id="how">How</a></li>
              <li class="nav-item"><a class="nav-link" href="dashboard.php" role="button" aria-haspopup="true" aria-expanded="false" id="why">Why</a></li>
              <li class="nav-item"><a class="nav-link" href="dashboard.php" role="button" aria-haspopup="true" aria-expanded="false" id="who">Who</a></li>
            ...
            <ul class="navbar-nav ms-auto">
              <li class="nav-item">
                <a class="nav-link" href="dashboard.php">
                    <span class="d-none d-lg-inline-block">
                        <span class="fas fa-chart-pie"></span> Tableau de bord
                    </span>
              ...
              <li class="nav-item">
                <a class="nav-link" href="profil.php">
                    <span class="d-none d-lg-inline-block">
                        <span class="fas fa-list-alt"></span> Profil
                    </span>
                    <span class="d-lg-none">Profil</span>
                </a>
              </li>
              <li class="nav-item"><a class="nav-link" href="login.php" role="button">Se connecter</a></li>
      ...
      <section class="py-0 overflow-hidden light" id="banner">
        ...
        <div class="container">
          <div class="row flex-center pt-8 pt-lg-10 pb-lg-9 pb-xl-0">
            <div class="col-md-11 col-lg-8 col-xl-4 pb-7 pb-xl-9 text-center text-xl-start"><a class="btn btn-outline-warning mb-4 fs--1 border-2 rounded-pill" href="#!"><span class="fas fa-star me-2"></span>Passer premium</a>
              <h1 class="text-white fw-light">Faites <span class="typed-text fw-bold" data-typed-text='["avancer","rentabiliser","agrandir","briller"]'></span><br />votre activité</h1>
              <p class="lead text-white opacity-75">Avec notre plateforme, vous bénéficierez de nombreux outils pouvant faciliter la gestion et l'organisation de vos projets !</p>
              <a class="btn btn-outline-light border-2 rounded-pill btn-lg mt-4 fs-0 py-2" href="#!">Réjoindre dès maintenant<span class="fas fa-play ms-2" data-fa-transform="shrink-6 down-1"></span></a>
            </div>
            <div class="col-xl-7 offset-xl-1 align-self-center mt-4 mt-xl-0"><a class="img-landing-banner rounded" href="index.php"><img class="img-fluid" src="assets/img/generic/settings.png" alt="" /></a></div>
          </div>
        </div>
        <!-- end of .container-->

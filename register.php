                ...
                <div class="row g-0 h-100">
                  <div class="col-md-5 text-center bg-card-gradient">
                    ...
                    <div class="mt-3 mb-4 mt-md-4 mb-md-5 light">
                      <p class="pt-3 text-white">Vous avez un compte ?<br><a class="btn btn-outline-light mt-2 px-4" href="pages/authentication/card/login.html">Connectez-vous</a></p>
                    </div>
                  </div>
                  <div class="col-md-7 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                      ...
                      <form>
                        <div class="mb-3">
                          <label class="form-label" for="card-name">Nom</label>
                        ...
                        <div class="row gx-2">
                          ...
                          <div class="mb-3 col-sm-6">
                            <label class="form-label" for="card-confirm-password">Confirmation</label>
                        ...
                        <div class="form-check">
                          ...
                          <label class="form-label" for="card-register-checkbox">J'accepte les<a href="#!">termes </a>et <a href="#!">politiques de confidentialités</a></label>
                        </div>
                        <div class="mb-3">
                          <button class="btn btn-primary d-block w-100 mt-3" type="submit" name="submit">S'inscrire</button>
                        </div>
                      </form>
                      <div class="position-relative mt-4">
                        <hr class="bg-300" />
                        <div class="divider-content-center">ou s'inscrire avec</div>
                      </div>
